    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i>  活动信息表格
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column label="活动图" align="center">
                    <template slot-scope="scope">
                        <el-image
                                class="table-td-thumb"
                                :src="scope.row.activityBanner"
                                :preview-src-list="[scope.row.activityBanner]"
                        ></el-image>
                    </template>
                </el-table-column>
                ...
                <el-table-column prop="activityStart" label="开始时间"></el-table-column>
                <el-table-column prop="activityEnd" label="结束时间"></el-table-column>
                <el-table-column label="状态" align="center">
                    <template slot-scope="scope">
                    <el-tag v-if="scope.row.status==='未开始'">未开始</el-tag>
                    <el-tag v-if="scope.row.status==='进行中'">已开始</el-tag>
                    <el-tag v-if="scope.row.status==='已过期'" type="danger">已结束</el-tag>
        ...
        <el-dialog title="添加" :visible.sync="insertVisible" width="30%">
            <el-form ref="form" :model="insertform" label-width="70px">
                ...
                <el-form-item label="活动名">
                    <el-input v-model="insertform.activityName"></el-input>
                </el-form-item>
                <el-form-item label="活动图片">
                    ...
                    <el-upload
                        ...
                        <img v-if="insertform.activityBanner" :src="insertform.activityBanner" class="avatar" enctype="multipart/form-data" width="100px" height="100px">
                        <i v-else class="el-icon-plus avatar-uploader-icon" style="width:100px; height:100px"></i>
                    </el-upload>
                </el-form-item>
                <el-form-item label="活动说明">
                    <el-input v-model="insertform.activityExplain"></el-input>
                </el-form-item>
                ...
                <el-form-item label="开始时间">
                    <el-date-picker
                            v-model="insertform.activityStart"
                            type="datetime"
                            placeholder="选择日期时间"
                ...
                <el-form-item label="结束时间">
                    <el-date-picker
                            v-model="insertform.activityEnd"
                            type="datetime"
                            placeholder="选择日期时间"
                            value-format="yyyy-MM-dd"
                            align="right"
                ...
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="广告图">
                            <el-image
                                    class="table-td-thumb"
                                    :src="checkform.activityBanner"
                                    :preview-src-list="[checkform.activityBanner]"
                            ></el-image>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="广告标题">
                            <el-tag type="info">{{checkform.activityName}}</el-tag>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="广告分类">
                            <el-tag type="info">{{checkform.activityExplain}}</el-tag>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        <el-form-item label="状态">
                            ...
                            <el-tag v-if="checkform.status==='未开始'">上架</el-tag>
                            <el-tag v-if="checkform.status==='进行中'">进行中</el-tag>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="updateform" label-width="70px">
                ...
                <el-form-item label="活动图">
                    <el-input v-model="updateform.activityName"></el-input>
                </el-form-item>
                <el-form-item label="活动图">
                   <!-- <el-input v-model="updateform.bannerPicture"></el-input>-->
                    <el-upload
                            ...
                            :on-success="handleAvatarSuccess"
                            :before-upload="beforeAvatarUpload" enctype="multipart/form-data"  >
                        <img v-if="updateform.activityBanner" :src="updateform.activityBanner" class="avatar" enctype="multipart/form-data" width="100px" height="100px">
                        <i v-else class="el-icon-plus avatar-uploader-icon" style="width:100px; height:100px"></i>
                    </el-upload>
                </el-form-item>

                <el-form-item label="活动说明">
                    <el-input v-model="updateform.activityExplain"></el-input>
                </el-form-item>
              <!--  <el-form-item label="状态">
                <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item>上架</el-dropdown-item>
                ...
                <el-form-item label="开始时间">
                    <el-date-picker
                            v-model="updateform.activityStart"
                            type="datetime"
                            placeholder="选择日期时间"
                ...
                <el-form-item label="结束时间">
                    <el-date-picker
                            v-model="updateform.activityEnd"
                            type="datetime"
                            placeholder="选择日期时间"
                            value-format="yyyy-MM-dd HH:mm:SS"
                            align="right"
    ...
    export default {
        ...
        methods: {
            handleAvatarSuccess(res, file) {
                console.log(res)
               this.insertform.activityBanner=URL.createObjectURL(file.raw);
                this.updateform.activityBanner = URL.createObjectURL(file.raw);
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        ...
                        this.$request.delete("/api/activity/findActiviytById?id="+index+"").then(res=>{
                            console.log(res)
                            if (res=="success"){
            ...
            statusOn(){
             ...
             //保存添加
             saveInsert(){
                 this.$request.post("/api/activity/insertActivity",this.insertform).then(res=>{
                     console.log(res)
                     if (res=="success"){
            ...
            saveEdit() {
                ...
                this.$request.put("/api/activity/updateActivity",this.updateform).then(res=>{
                    console.log(res)
                    if (res==="success"){
